...
Documentation
-------------
Autogenerated API documentation is found here: `<https://pythonhosted.org/chempy>`_
(and dev docs are here: `<http://hera.physchem.kth.se/~chempy/branches/master/html>`_).
